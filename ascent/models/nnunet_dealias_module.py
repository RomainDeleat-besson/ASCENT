...
class nnUNetDealiasLitModule(nnUNetRegLitModule):
    ...
    Similar to nnUNetRegLitModule except for the definition of class's
    variables: threeD, patch_size, num_classes as the U-Net is no longer
    equals self.net but self.net.denoiser.
    """
